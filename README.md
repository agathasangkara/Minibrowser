...
This software is provided "as is", without warranty of any kind. You are granted a free, non-exclusive license to use Minibrowser for personal and commercial purposes. See [LICENSE.txt](LICENSE.txt) for full terms.
